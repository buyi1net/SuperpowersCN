...
description: 引导用户完成结构化文档协作：收集上下文、迭代组织内容，并用读者测试发现盲点。用户说"写个文档""起草提案""写技术规范""整理 RFC""一起改文档""帮我润色结构"时使用；勿触发于把当前上下文生成并发布 PRD 的场景，那些走 to-prd。
---

# 文档协作工作流程

此技能提供一个结构化流程，带领用户完成协作文档创建。作为引导者，全程引导用户走完三个阶段：上下文收集、优化与结构化、读者测试。
