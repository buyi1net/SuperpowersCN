...
START_SCRIPT="$REPO_ROOT/skills/dev/brainstorming/scripts/start-server.sh"
STOP_SCRIPT="$REPO_ROOT/skills/dev/brainstorming/scripts/stop-server.sh"
SERVER_JS="$REPO_ROOT/skills/dev/brainstorming/scripts/server.cjs"
