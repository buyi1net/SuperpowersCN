...
START_SCRIPT="$REPO_ROOT/skills/design/brainstorming/scripts/start-server.sh"
STOP_SCRIPT="$REPO_ROOT/skills/design/brainstorming/scripts/stop-server.sh"
SERVER_JS="$REPO_ROOT/skills/design/brainstorming/scripts/server.js"
